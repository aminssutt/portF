...
const s: Record<string, Record<Lang, string>> = {
  ...
  proj_ecu_desc:      { en: "built an ECU software testing app to compare expected vs actual behavior in normal and failure scenarios, with fault simulation and pass/fail safety results with car simulation.", fr: "Projet etudiant a Troyes (mai 2024) : application de test ECU comparant comportement attendu vs reel en conduite normale et en panne, avec simulation de defauts et resultats pass/fail clairs.", ko: "트루아 학생 프로젝트(2024년 5월): 정상/고장 시나리오에서 예상값과 실제값을 비교하는 ECU 테스트 앱을 개발하고, 고장 시뮬레이션과 명확한 pass/fail 안전 결과를 제공." },
